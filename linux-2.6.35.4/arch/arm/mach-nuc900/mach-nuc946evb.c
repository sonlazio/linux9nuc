/*
 * linux/arch/arm/mach-w90x900/mach-nuc946evb.c
 *
...
static void __init nuc946evb_map_io(void)
{
	nuc946_map_io();
	nuc946_init_clocks();
}

static void __init nuc946evb_init(void)
{
	nuc946_board_init();
        i2c_register_board_info(0, nuc900_i2c_clients, sizeof(nuc900_i2c_clients)/sizeof(struct i2c_board_info));
}

MACHINE_START(W90X900, "W90P946EVB")
	/* Maintainer: Wan ZongShun */
	.phys_io	= W90X900_PA_UART,
	.io_pg_offst	= (((u32)W90X900_VA_UART) >> 18) & 0xfffc,
	.boot_params	= 0x100,
	.map_io		= nuc946evb_map_io,
	.init_irq	= nuc900_init_irq,
	.init_machine	= nuc946evb_init,
	.timer		= &nuc900_timer,
MACHINE_END
