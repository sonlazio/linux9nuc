...
static struct nuc900fb_display  nuc900_lcd_info[] = {
	...
	/* AU Optronics CO. A035QN02 320x240 Color TFT LCD */	
	[1] = {
		.type		= LCM_DCCS_VA_SRC_RGB565,
		.width		= 320,
		.height		= 240,
	...
	/* Ampire CO. AM-800480RBTMQW 800x480 Color TFT LCD */
	[2] = {
		.type		= LCM_DCCS_VA_SRC_RGB565,
		.width		= 800,
		.height		= 480,
...
static struct nuc900fb_mach_info nuc900_fb_info = {
	...
	.default_display	= 0,
#elif defined(CONFIG_A035QN02_320X240)
  .default_display	= 1,
#elif defined(CONFIG_AM800480RBTMQW_800X480)
  .default_display	= 2, 
#else
	.default_display	= 0,
#endif	
